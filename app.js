...
app.post('/home', (req, res) => {
  ...
  Promise.all([connection.query(dailyUserInfoQuery), connection.query(dailyUserAchievementsInfoQuery), connection.query(dailyUserTrainingsQuery)]).then(([dailyUserInfo, dailyUserAchievements, dailyUserTrainings]) => {
